...
older as (select * from ranked where snapshot_rank > 1)
...
select
    ...
    case
        ...
        when older.valid_to < older.snapshot_as_of then 'a superseded version now ends elsewhere'
...
where
    ...
    or (older.valid_to < older.snapshot_as_of and newest.valid_to <> older.valid_to)
    or (older.valid_to >= older.snapshot_as_of and newest.valid_to < older.snapshot_as_of)
